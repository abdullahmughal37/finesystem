...
- Book catalog, issue, and return lookup searches every built-in book column plus active custom fields. Issue and return screens show debounced suggestions with the matched field, core catalog details, and current availability or borrower context.
